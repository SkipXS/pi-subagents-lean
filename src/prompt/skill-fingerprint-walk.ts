/**
 * Bounded asynchronous walker for skill-source fingerprints.
 *
 * The walker owns filesystem metadata, path records, and shared budgets. The
 * fingerprint facade only serializes the returned record snapshot.
 */
 ...
 * filesystem calls; relative names and stable metadata keep values semantic
 * rather than dependent on that spelling.
 */
...
/** Walk one source without reading file contents. */
